...
public class ShineButton extends PorterShapeImageView {
    ...
    onAnimontListener animontListener;
    ...
    public void setonAnimontListener(onAnimontListener listener) {
        this.animontListener = listener;
    }
    ...
    private void doShareAnim() {
        ...
        shakeAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                setSrcColor(btnFillColor);
                if (animontListener != null) {
                    animontListener.onAnimationStart();
                }
            }
    ...
    public interface onAnimontListener {
        void onAnimontEnd();
